...
impl EconomyAnalyticsManager {
    ...
    pub fn calculate_health_score(analytics: &EconomyAnalytics) -> u32 {
        ...
        if analytics.total_currency_minted > 0 {
            let burn_ratio = (analytics.total_currency_burned * 100) / analytics.total_currency_minted;
            if burn_ratio > 80 {
    ...
    pub fn generate_economy_report(
        ...
        let market_velocity = Self::calculate_market_velocity(total_supply, analytics.total_trade_volume, 30);
