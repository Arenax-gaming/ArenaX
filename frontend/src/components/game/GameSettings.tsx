  ...
  return (
    <div className="bg-white/10 backdrop-blur-lg rounded-xl border border-white/20 p-6">
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="difficulty" className="block text-gray-300 text-sm mb-2">Difficulty</label>
          <select
            id="difficulty"
        ...
        <div>
          <label htmlFor="map" className="block text-gray-300 text-sm mb-2">Map</label>
          <select
            id="map"
            value={settings.map}
